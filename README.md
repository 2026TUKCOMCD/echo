...
| Step 3 | 대화 시작 (Click) | 앱 메인 화면의 **[대화 시작하기]** 버튼 클릭 시 백그라운드에서 자동 실행됨<br/>1) Health Connect: 오늘 걸음 수 및 심박수 즉시 추출<br/>2) Fused Location Provider: 현재 위치 및 이동 경로 분석<br/>3) Stay Point Detection: 방문 장소(예: 정왕 시장) 및 체류 시간 계산 |
